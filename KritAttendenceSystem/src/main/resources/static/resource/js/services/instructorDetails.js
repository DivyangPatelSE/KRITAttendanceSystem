...
var Instructor = function() {
	...
	this.toJsonInstructorDTO = function(instructor) {
		return {
			"instructorId" : instructor.INSTRUCTOR_ID == undefined
					&& instructor.INSTRUCTOR_ID == null ? null
					: instructor.INSTRUCTOR_ID,
			"instructorFirstName" : instructor.INSTRUCTOR_FIRST_NAME == undefined
					&& instructor.INSTRUCTOR_FIRST_NAME == null ? null
					: instructor.INSTRUCTOR_FIRST_NAME,
			"instructorLastName" : instructor.INSTRUCTOR_LAST_NAME == undefined
					&& instructor.INSTRUCTOR_LAST_NAME == null ? null
					: instructor.INSTRUCTOR_LAST_NAME,
			"instructorAddress" : instructor.INSTRUCTOR_ADDRESS == undefined
					&& instructor.INSTRUCTOR_ADDRESS == null ? null
					: instructor.INSTRUCTOR_ADDRESS,
			"instructorEmail" : instructor.INSTRUCTOR_EMAIL == undefined
					&& instructor.INSTRUCTOR_EMAIL == null ? null
					: instructor.INSTRUCTOR_EMAIL,
			"password" : instructor.PASSWORD == undefined
					&& instructor.PASSWORD == null ? null : instructor.PASSWORD,
			"instructorPhoto" : instructor.INSTRUCTOR_PHOTO == undefined
					&& instructor.INSTRUCTOR_PHOTO == null ? null
	 ...
	 * indexes) { this.instructors[indexes[i]].IS_DELETED = true; } return
	 * this.instructors; } };
	 */
